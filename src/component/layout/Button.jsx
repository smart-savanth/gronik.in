    ...
    <>
      ...
      >
        <button
          ...
          className={`group relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-18 lg:h-18 xl:w-20 xl:h-20 bg-gradient-to-br from-[#2D1B3D] to-[#4A3B5C] ${isRectangle ? 'rounded-xl' : 'rounded-full'} shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-110 hover:-translate-y-1 border-2 border-white/20 backdrop-blur-sm cursor-pointer`}
          style={{ 
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full">
            <span className="block text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] font-extrabold leading-tight mb-1 text-white" style={{ fontFamily: 'Quicksand, Nunito, Playfair Display, serif', letterSpacing: '0.08em', textShadow: '0 2px 8px rgba(0,0,0,0.13)' }}>
              Why
            </span>
            <span className="block text-[8px] sm:text-[9px] md:text-[10px] lg:text-[11px] xl:text-[12px] font-extrabold leading-tight text-white" style={{ fontFamily: 'Quicksand, Nunito, Playfair Display, serif', letterSpacing: '0.10em', textShadow: '0 2px 8px rgba(0,0,0,0.13)' }}>
        ...
        <div 
          className={`fixed inset-0 bg-black/20 backdrop-blur-md transition-all duration-700 ${isHovered ? 'opacity-100' : 'opacity-0 pointer-events-none'}`} 
          style={{ zIndex: -1 }}
        ></div>
