    ...
    <section id="about" className="py-12 sm:py-16 lg:py-24 bg-gradient-to-b from-gronik-bg to-gronik-primary relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Content */}
          <div className="bg-gronik-shadow/30 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-gronik-accent/20 hover:border-gronik-accent/40 transition-all duration-300">
            <div className="space-y-4 sm:space-y-6 lg:space-y-8 text-center lg:text-left">
              <p className="text-sm sm:text-base lg:text-xl text-gronik-light/90 leading-relaxed">
              ...
              <div className="pt-4 sm:pt-6 lg:pt-8">
                <div className="bg-gradient-to-r from-gronik-accent/20 to-gronik-secondary/20 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-gronik-accent/30">
                  <p className="text-base sm:text-lg lg:text-2xl text-white font-semibold text-center">
          ...
          {/* Features Grid - Single Row on Mobile */}
          <div className="grid grid-cols-3 gap-3 sm:gap-6 lg:gap-8 mt-8 sm:mt-12 lg:mt-16">
            <div className="text-center">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-gronik-accent to-gronik-secondary rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-4">
                <span className="text-lg sm:text-2xl">📚</span>
              </div>
              <h3 className="text-xs sm:text-sm lg:text-lg font-semibold text-white mb-1 sm:mb-2">Vast Collection</h3>
              <p className="text-gronik-light/80 text-xs sm:text-sm">Access thousands of books across all genres</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xs sm:text-sm lg:text-lg font-semibold text-white mb-1 sm:mb-2">Instant Access</h3>
              <p className="text-gronik-light/80 text-xs sm:text-sm">Read anywhere, anytime on any device</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xs sm:text-sm lg:text-lg font-semibold text-white mb-1 sm:mb-2">Premium Quality</h3>
              <p className="text-gronik-light/80 text-xs sm:text-sm">Curated selection of high-quality content</p>
            </div>
          </div>
        </div>
      </div>
