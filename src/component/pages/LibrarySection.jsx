...
export const centralizedBooksData = [
  {
    ...
    description:
      "Transform your mindset and unlock the secrets to wealth and success.",
    badge: "BESTSELLER",
    discount: "25% OFF",
    featured: true,
    hero: true,
  ...
  },
  {
    ...
    description:
      "Master the art of power and influence in every aspect of life.",
    badge: "TRENDING",
    discount: "20% OFF",
    featured: true,
    hero: true,
  ...
  },
  {
    ...
    description:
      "Build good habits, break bad ones, and get 1% better every day.",
    badge: "NEW RELEASE",
    discount: "22% OFF",
    featured: true,
    hero: true,
...
console.log("IS ERROR:", isError);
  ...
  return (
    <div
      className="lg:px-12 min-h-screen bg-[#9B7BB8] relative overflow-hidden"
      key={JSON.stringify(cart) + JSON.stringify(wishlist)}
    >
      {/* Background Pattern */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-2 lg:pt-10 relative z-10">
        ...
        <div className="w-full mb-8 space-y-2">
          ...
          {isFilterOpen && (
            <div className="mt-2 flex flex-col gap-2 bg-[#2D1B3D]/95 backdrop-blur-md rounded-2xl border border-[#3D2A54]/50 shadow-2xl p-2 lg:hidden">
              {["All", ...new Set(books.map((b) => b.category))].map(
                (category) => (
                  <button
                    key={category}
                    onClick={() => {
        ...
        <div className="flex justify-center mb-12">
          <div className="grid grid-cols-2 gap-1 px-4 sm:gap-6 lg:gap-8 lg:grid-cols-4 w-full">
            {currentBooks.map((book, index) => (
              ...
              >
                <div
                  className={` group relative bg-[#1A0F2E]/80 backdrop-blur-md 
                  ...
                  <div className="text-center flex-1 flex flex-col justify-between">
                    ...
                    <div className="mb-2 sm:mb-3">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-xs sm:text-xs lg:text-sm text-green-400 font-medium">
                          {book.discount}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-row gap-2 w-full mb-4">
                     {book.isPurchased ? (
  <>
    {/* View in Library (Primary Action) */}
    <button
      onClick={(e) => {
        e.stopPropagation();
        navigate("/my-library");
      ...
      text-white hover:scale-105 transition-all shadow-xl"
    >
      View in Library
    </button>

    {/* Open Product Page Icon */}
    <button
      onClick={(e) => {
        e.stopPropagation();
        navigate(`/product/${book.id}`);
      }}
      className="p-3 rounded-xl bg-[#9B7BB8] text-white hover:scale-105 transition-all"
    >
    ...
    <span className="added-text absolute inset-0 flex items-center justify-center">
      ...
      Added!
                          ...
                          <button
                            ...
                            className="p-3 rounded-xl bg-[#9B7BB8] text-[#2D1B3D]"
                          >
                            <Heart
                              className={`w-5 h-5 ${isInWishlist(book) ? "fill-current" : ""}`}
                            />
                          </button>
                        </>
                      )}
