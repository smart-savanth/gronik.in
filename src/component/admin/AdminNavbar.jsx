        ...
        <div className="flex items-center space-x-8 ml-10">
          {adminMenu.map((item) => (
            <Link
              key={item.name}
              to={item.path}
              className={`flex items-center space-x-2 px-4 py-3 rounded-lg font-medium transition-all duration-200 hover:text-gronik-accent hover:bg-gronik-secondary/10 ${
